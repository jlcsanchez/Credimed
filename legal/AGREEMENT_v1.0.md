# CREDIMED SERVICE AGREEMENT (v1.0)
...
All claims are prepared using standard CDT codes and submitted to your insurer's claims portal within 24 hours of receiving complete documentation and your signed authorization.

## 2. No Refund = No Fee

If your insurer issues a formal denial indicating that no reimbursement is payable under your plan, and such denial is upheld after one (1) Credimed-supported resubmission, you owe Credimed no additional fees beyond the one-time submission fee already paid.

For purposes of this Agreement, a "formal denial" means a written determination issued by the insurer stating that no reimbursement is payable under the Member's plan.

Credimed does not charge any percentage of your reimbursement. The one-time fee paid at checkout represents the full extent of your financial obligation to us.

For the avoidance of doubt, any reimbursement issued by your insurer, including partial reimbursement, shall be considered a successful claim. A claim shall be deemed successful if the insurer issues any payment, regardless of amount, relative to the submitted services. In such cases, the service fee is fully earned and non-refundable.

### Resubmission Policy (Plan-Based)

The number of resubmissions included in the service depends on the plan selected at checkout:

- **Basic Plan:** includes one (1) resubmission following an initial denial.
- **Plus Plan:** includes unlimited resubmissions for the same claim within a twelve (12) month period from the original submission date.

All resubmissions must relate to the same claim and may be subject to insurer deadlines, documentation requirements, and plan limitations.
